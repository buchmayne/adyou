...
multifamily_housing_inventory.to_postgis('mf_inventory', con=engine, if_exists='replace', index=True)

# BOUNDARY
school_district = gpd.read_file(join(boundary_folder, 'school_district.shp'))
school_district.to_postgis('school_district', con=engine, if_exists='replace')
